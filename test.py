...
def select_model(args, device):
    ...
    if model_id == 0:
        ...
        from models.team27_FUSION import FUSION
        name = f"{model_id:02}_FUSION"
        model_path = {
        "dat": "./model_zoo/team27_dat.pth",
        "swinir": "./model_zoo/team27_swinir.pth",
        "rfdn": "./model_zoo/team27_rfdn.pth",
        "fusion": "./model_zoo/team27_fusionNet.pth"
        }
        model_func = FUSION
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_dir", default="./data/DIV2K_test_LR", type=str, help="Path to the test set")
    parser.add_argument("--save_dir", default="NTIRE2025-ImageSRx4/results", type=str)
    parser.add_argument("--model_id", default=27, type=int)
